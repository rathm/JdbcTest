 ...
 * 
 * Examples: (1) java <class-path> JdbcTest username password "jdbc:oracle:oci:@DBINSTANCE"
 *           (2) java <class-path> JdbcTest username password "jdbc:oracle:thin:@DBINSTANCE"
 *           (3) java <class-path> JdbcTest username password "jdbc:oracle:oci:@(DESCRIPTION=(FAILOVER=on)(ADDRESS_LIST=(ADDRESS=(PROTOCOL=TCP)(HOST=db-server-01.acme.com)(PORT=1521)))(CONNECT_DATA=(SERVICE_NAME=DBINSTANCE)(FAILOVER_MODE=(TYPE=session)(METHOD=basic))))"
 *           (4) java <class-path> JdbcTest username password "jdbc:oracle:thin:@(DESCRIPTION=(FAILOVER=on)(ADDRESS_LIST=(ADDRESS=(PROTOCOL=TCP)(HOST=db-server-01.acme.com)(PORT=1521)))(CONNECT_DATA=(SERVICE_NAME=DBINSTANCE)(FAILOVER_MODE=(TYPE=session)(METHOD=basic))))"
 *           (5) java <class-path> JdbcTest username password "jdbc:oracle:oci:@db-server-01.acme.com:1521:DBINSTANCE"
 *           (6) java <class-path> JdbcTest username password "jdbc:oracle:thin:@db-server-01.acme.com:1521:DBINSTANCE"
 *           (7) java <class-path> JdbcTest username password "jdbc:oracle:thin:@//db-server-01.acme.com:1521/DBINSTANCE"
 *
